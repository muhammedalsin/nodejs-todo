...
const {user_index_get ,user_search_post,user_add_get,user_view_get,user_post,user_delete} = require("../controllers/userControllers")
...
router.post("/user/add.html", user_post);
